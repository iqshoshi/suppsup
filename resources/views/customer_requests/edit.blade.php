...
<head>
    ...
    <title>Edit Customer Request</title>
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('customer-requests.update', $request->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="sku_code" id="sku_code" required placeholder="Enter SKU code" value="{{ old('sku_code', $request->sku_code) }}">
                        @error('sku_code')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="brand" id="brand" required placeholder="Enter brand name" value="{{ old('brand', $request->brand) }}">
                        @error('brand')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="customer_name" id="customer_name" required placeholder="Enter customer name" value="{{ old('customer_name', $request->customer_name) }}">
                        @error('customer_name')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-input" name="contact_no" id="contact_no" required placeholder="(123) 456-7890" value="{{ old('contact_no', $request->contact_no) }}">
                        @error('contact_no')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="associate" id="associate" required placeholder="Enter associate name" value="{{ old('associate', $request->associate) }}">
                        @error('associate')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea class="form-textarea" name="notes" id="notes" placeholder="Add any additional notes or special instructions...">{{ old('notes', $request->notes) }}</textarea>
                        @error('notes')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
